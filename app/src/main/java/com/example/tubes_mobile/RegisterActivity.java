...
public class RegisterActivity extends AppCompatActivity {
    private EditText editEmail, editName, editPassword, editPasswordConf;
    ...
    private void reload(){
        startActivity(new Intent(getApplicationContext(), com.example.tubes_mobile.activities.MainActivity.class));
    }
